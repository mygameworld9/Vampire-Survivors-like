...
| CHAIN | 链式 | 弹跳传递 | 弹跳次数 | 🔗 链电 |
| TRAP | 陷阱 | 静止放置 | 最大陷阱数 | ⚙️ 尖刺陷阱 |
...
| 参数 | 说明 | 典型值 |
|:---|:---|:---:|
| range | 挥砍半径 (px) | 60~140 |
| cooldown | 挥砍间隔 (ms) | 700~1500 |
| penetration | 可击中敌人数 | 3~999 |
| statusEffect | 附加状态效果 | POISON/无 |
...
|:---|:---:|:---:|:---:|:---|
| ⚔️ 武士刀 | 45 | 80 | 1500ms | - |
| 🧪 毒匕首 | 25 | 60 | 1200ms | POISON 3/s |
| 🐍 毒液之牙 | 65 | 90 | 900ms | POISON 8/s |
| ☠️ 瘟疫镰刀 | 120 | 140 | 700ms | POISON 15/s (扩散) |
| ⚔️ 暗影之刃 | 90 | 120 | 800ms | - (暗属性) |
